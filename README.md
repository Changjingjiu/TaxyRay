...
| **价税拆分**<br/>整单优惠与抹零 按实付分摊<br/>13% / 9% / 6% / 0% 与自定义税率 | **税率参考**<br/>每种税率单独一行<br/>点击类别查看典型代表与适用条件 |
...
遇到抹零或整单优惠 填写实际支付金额后点击 **按实付分摊优惠** 即可<br/>
例如商品合计 **¥59.24** 实付 **¥59.20** 确认后分摊 **¥0.04** 再按各商品税率计算
...
整单优惠按商品金额比例分摊 尾差用最大余数法补齐 不把差额塞到最后一项<br/>
单品已有会员价时直接录入折后金额 仅部分商品优惠时修改对应商品
