...
| 核心能力 | 做了什么 |
| --- | --- |
| **AI 小票识别** | 同一张长小票最多选择或拍摄 5 张照片 一次识别商品 金额与优惠 保存前提醒相似账单 |
...
3. 回到首页 点击 **识别小票** 拍照或多选图片 同一张长小票最多 5 张 按上下顺序排列后确认发送
4. 查看识别结果与税额 有整单优惠时确认分摊 相似账单会再次询问 保存后可分享单笔或累计贡献卡
...
首页累计卡包含全部已保存账单 不受账本搜索或时间筛选影响 相似记录只作提醒 不会自动合并或删除
